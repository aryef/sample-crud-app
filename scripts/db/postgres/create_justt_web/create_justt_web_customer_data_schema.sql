...
create table customer (
	...
	update_user UUID,  
	db_user varchar(20) NOT NULL DEFAULT current_user
...
create table transaction_register (
    ...
    credit_card_type varchar(15), --TODO FK to table credit_card
	...
	transaction_amount_in_base_ccy numeric(16,4)  not null default 0,  -- base_ccy should be recalculated if changed by system administrator, it IS complicated
...
USING btree (customer_seq, created_at);
